...
class Manager {
    ...
    constructor(app) {
         ...
         */
        this.operationremove = new CustomEvent("operationremove", {
            bubbles: true,
        });
        /**
    ...
    confirmWaitersLoaded() {
        if (
            this.tabs.getActiveTab("input") >= 0 &&
    ...
    initialiseEventListeners() {
        ...
        window.addEventListener(
            "resize",
            this.window.windowResize.bind(this.window),
        );
        window.addEventListener(
            "blur",
            this.window.windowBlur.bind(this.window),
        );
        window.addEventListener(
            "focus",
            this.window.windowFocus.bind(this.window),
        );
        window.addEventListener(
            "statechange",
            this.app.stateChange.bind(this.app),
        );
        ...
        document
            ...
            .addEventListener(
                "click",
                this.controls.bakeClick.bind(this.controls),
            );
        document
            .getElementById("auto-bake")
            .addEventListener(
                "change",
                this.controls.autoBakeChange.bind(this.controls),
            );
        document
            .getElementById("step")
            .addEventListener(
                "click",
                this.controls.stepClick.bind(this.controls),
            );
        document
            .getElementById("clr-recipe")
            .addEventListener(
                "click",
                this.controls.clearRecipeClick.bind(this.controls),
            );
        document
            .getElementById("save")
            .addEventListener(
                "click",
                this.controls.saveClick.bind(this.controls),
            );
        document
            .getElementById("save-button")
            .addEventListener(
                "click",
                this.controls.saveButtonClick.bind(this.controls),
            );
        document
            .getElementById("save-link-recipe-checkbox")
            .addEventListener(
                "change",
                this.controls.slrCheckChange.bind(this.controls),
            );
        document
            .getElementById("save-link-input-checkbox")
            .addEventListener(
                "change",
                this.controls.sliCheckChange.bind(this.controls),
            );
        document
            .getElementById("load")
            .addEventListener(
                "click",
                this.controls.loadClick.bind(this.controls),
            );
        document
            .getElementById("load-delete-button")
            .addEventListener(
                "click",
                this.controls.loadDeleteClick.bind(this.controls),
            );
        document
            .getElementById("load-name")
            .addEventListener(
                "change",
                this.controls.loadNameChange.bind(this.controls),
            );
        document
            .getElementById("load-button")
            .addEventListener(
                "click",
                this.controls.loadButtonClick.bind(this.controls),
            );
        document
            .getElementById("support")
            .addEventListener(
                "click",
                this.controls.supportButtonClick.bind(this.controls),
            );
        this.addMultiEventListeners(
            "#save-texts textarea",
            "keyup paste",
            this.controls.saveTextChange,
            this.controls,
        );
        ...
        this.addMultiEventListener(
            "#search",
            "keyup paste search",
            this.ops.searchOperations,
            this.ops,
        );
        this.addDynamicListener(
            ".op-list li.operation",
            "dblclick",
            this.ops.operationDblclick,
            this.ops,
        );
        document
            .getElementById("edit-favourites")
            .addEventListener(
                "click",
                this.ops.editFavouritesClick.bind(this.ops),
            );
        document
            .getElementById("save-favourites")
            .addEventListener(
                "click",
                this.ops.saveFavouritesClick.bind(this.ops),
            );
        document
            .getElementById("reset-favourites")
            .addEventListener(
                "click",
                this.ops.resetFavouritesClick.bind(this.ops),
            );
        this.addDynamicListener(
            ".op-list",
            "oplistcreate",
            this.ops.opListCreate,
            this.ops,
        );
        this.addDynamicListener(
            "li.operation",
        ...
        this.addDynamicListener(
            ".arg:not(select)",
            "input",
            this.recipe.ingChange,
            this.recipe,
        );
        this.addDynamicListener(
            ".arg[type=checkbox], .arg[type=radio], select.arg",
            "change",
            this.recipe.ingChange,
            this.recipe,
        );
        this.addDynamicListener(
            ".disable-icon",
            "click",
            this.recipe.disableClick,
            this.recipe,
        );
        this.addDynamicListener(
            ".breakpoint",
            "click",
            this.recipe.breakpointClick,
            this.recipe,
        );
        this.addDynamicListener(
            "#rec-list li.operation",
            "dblclick",
            this.recipe.operationDblclick,
            this.recipe,
        );
        this.addDynamicListener(
            "#rec-list li.operation > div",
            "dblclick",
            this.recipe.operationChildDblclick,
            this.recipe,
        );
        this.addDynamicListener(
            "#rec-list .dropdown-menu.toggle-dropdown a",
            "click",
            this.recipe.dropdownToggleClick,
            this.recipe,
        );
        this.addDynamicListener(
            "#rec-list",
            "operationremove",
            this.recipe.opRemove.bind(this.recipe),
        );
        this.addDynamicListener(
            "textarea.arg",
            "dragover",
            this.recipe.textArgDragover,
            this.recipe,
        );
        this.addDynamicListener(
            "textarea.arg",
            "dragleave",
            this.recipe.textArgDragLeave,
            this.recipe,
        );
        this.addDynamicListener(
            "textarea.arg",
            "drop",
            this.recipe.textArgDrop,
            this.recipe,
        );
        ...
        document
            ...
            .addEventListener("click", this.app.resetLayout.bind(this.app));
        this.addListeners(
            "#clr-io,#btn-close-all-tabs",
            "click",
            this.input.clearAllIoClick,
            this.input,
        );
        this.addListeners(
            "#open-file,#open-folder",
            "change",
            this.input.inputOpen,
            this.input,
        );
        document
            ...
            .addEventListener(
                "click",
                this.input.inputOpenClick.bind(this.input),
            );
        document
            .getElementById("btn-open-folder")
            .addEventListener(
                "click",
                this.input.folderOpenClick.bind(this.input),
            );
        this.addListeners(
            "#input-wrapper",
            "dragover",
            this.input.inputDragover,
            this.input,
        );
        this.addListeners(
            "#input-wrapper",
            "dragleave",
            this.input.inputDragleave,
            this.input,
        );
        this.addListeners(
            "#input-wrapper",
            "drop",
            this.input.inputDrop,
            this.input,
        );
        document
            ...
            .addEventListener(
                "click",
                this.input.addInputClick.bind(this.input),
            );
        document
            .getElementById("btn-previous-input-tab")
            .addEventListener(
                "mousedown",
                this.input.previousTabClick.bind(this.input),
            );
        document
            .getElementById("btn-next-input-tab")
            .addEventListener(
                "mousedown",
                this.input.nextTabClick.bind(this.input),
            );
        this.addListeners(
            "#btn-next-input-tab,#btn-previous-input-tab",
            "mouseup",
            this.input.tabMouseUp,
            this.input,
        );
        this.addListeners(
            "#btn-next-input-tab,#btn-previous-input-tab",
        ...
        document
            .getElementById("btn-go-to-input-tab")
            .addEventListener("click", this.input.goToTab.bind(this.input));
        document
            .getElementById("btn-find-input-tab")
            .addEventListener("click", this.input.findTab.bind(this.input));
        this.addDynamicListener(
            "#input-tabs li .input-tab-content",
            "click",
            this.input.changeTabClick,
            this.input,
        );
        document
            .getElementById("input-show-pending")
            .addEventListener(
                "change",
                this.input.filterTabSearch.bind(this.input),
            );
        document
            .getElementById("input-show-loading")
            .addEventListener(
                "change",
                this.input.filterTabSearch.bind(this.input),
            );
        document
            .getElementById("input-show-loaded")
            .addEventListener(
                "change",
                this.input.filterTabSearch.bind(this.input),
            );
        this.addListeners(
            "#input-filter-content,#input-filter-filename",
            "click",
            this.input.filterOptionClick,
            this.input,
        );
        document
        ...
        document
            .getElementById("input-num-results")
            .addEventListener(
                "change",
                this.input.filterTabSearch.bind(this.input),
            );
        ...
        document
            .getElementById("input-filter-refresh")
            .addEventListener(
                "click",
                this.input.filterTabSearch.bind(this.input),
            );
        this.addDynamicListener(
            ".input-filter-result",
            "click",
            this.input.filterItemClick,
            this.input,
        );

        // Output
        document
            .getElementById("save-to-file")
            .addEventListener("click", this.output.saveClick.bind(this.output));
        document
            .getElementById("save-all-to-file")
            .addEventListener(
                "click",
                this.output.saveAllClick.bind(this.output),
            );
        document
            .getElementById("copy-output")
            .addEventListener("click", this.output.copyClick.bind(this.output));
        document
            .getElementById("switch")
            .addEventListener(
                "click",
                this.output.switchClick.bind(this.output),
            );
        document
            .getElementById("maximise-output")
            .addEventListener(
                "click",
                this.output.maximiseOutputClick.bind(this.output),
            );
        document
            .getElementById("magic")
            .addEventListener(
                "click",
                this.output.magicClick.bind(this.output),
            );
        this.addDynamicListener(
            ".extract-file,.extract-file i",
            "click",
            this.output.extractFileClick,
            this.output,
        );
        this.addDynamicListener(
            "#output-tabs-wrapper #output-tabs li .output-tab-content",
            "click",
            this.output.changeTabClick,
            this.output,
        );
        document
            .getElementById("btn-previous-output-tab")
            .addEventListener(
                "mousedown",
                this.output.previousTabClick.bind(this.output),
            );
        document
            .getElementById("btn-next-output-tab")
            .addEventListener(
                "mousedown",
                this.output.nextTabClick.bind(this.output),
            );
        this.addListeners(
            "#btn-next-output-tab,#btn-previous-output-tab",
            "mouseup",
            this.output.tabMouseUp,
            this.output,
        );
        this.addListeners(
            "#btn-next-output-tab,#btn-previous-output-tab",
        ...
        document
            .getElementById("btn-go-to-output-tab")
            .addEventListener("click", this.output.goToTab.bind(this.output));
        document
            .getElementById("btn-find-output-tab")
            .addEventListener("click", this.output.findTab.bind(this.output));
        document
            .getElementById("output-show-pending")
            .addEventListener(
                "change",
                this.output.filterTabSearch.bind(this.output),
            );
        document
            .getElementById("output-show-baking")
            .addEventListener(
                "change",
                this.output.filterTabSearch.bind(this.output),
            );
        document
            .getElementById("output-show-baked")
            .addEventListener(
                "change",
                this.output.filterTabSearch.bind(this.output),
            );
        document
            .getElementById("output-show-stale")
            .addEventListener(
                "change",
                this.output.filterTabSearch.bind(this.output),
            );
        document
            .getElementById("output-show-errored")
            .addEventListener(
                "change",
                this.output.filterTabSearch.bind(this.output),
            );
        document
            .getElementById("output-content-filter")
            .addEventListener(
                "change",
                this.output.filterTabSearch.bind(this.output),
            );
        ...
        document
            .getElementById("output-num-results")
            .addEventListener(
                "change",
                this.output.filterTabSearch.bind(this.output),
            );
        ...
        document
            .getElementById("output-filter-refresh")
            .addEventListener(
                "click",
                this.output.filterTabSearch.bind(this.output),
            );
        ...
        document
            ...
            .addEventListener(
                "click",
                this.options.optionsClick.bind(this.options),
            );
        document
            .getElementById("reset-options")
            .addEventListener(
                "click",
                this.options.resetOptionsClick.bind(this.options),
            );
        this.addDynamicListener(
            ".option-item input[type=checkbox]",
            "change",
            this.options.switchChange,
            this.options,
        );
        this.addDynamicListener(
            ".option-item input[type=checkbox]#wordWrap",
            "change",
            this.options.setWordWrap,
            this.options,
        );
        this.addDynamicListener(
            ".option-item input[type=checkbox]#useMetaKey",
            "change",
            this.bindings.updateKeybList,
            this.bindings,
        );
        ...
        document
            ...
            .addEventListener(
                "change",
                this.options.themeChange.bind(this.options),
            );
        document
            .getElementById("logLevel")
            .addEventListener(
                "change",
                this.options.logLevelChange.bind(this.options),
            );

        // Misc
        window.addEventListener(
            "keydown",
            this.bindings.parseInput.bind(this.bindings),
        );
    }
    ...
    addMultiEventListener(selector, eventTypes, callback, scope) {
        ...
        for (let i = 0; i < evs.length; i++) {
            document
                ...
                .addEventListener(evs[i], callback.bind(scope));
        }
    }
    ...
    addDynamicListener(selector, eventType, callback, scope) {
        ...
        if (
            ...
            document.addEventListener(
                eventType,
                this.dynamicListenerHandler.bind(this),
            );
        }
    }
