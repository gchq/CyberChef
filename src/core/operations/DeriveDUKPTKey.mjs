...
class DeriveDUKPTKey extends Operation {
    ...
    constructor() {
        ...
        this.module = "Payment";
        this.description = "Paste the Base Derivation Key (BDK) into the input field as a 16-byte hex value.<br><br>Put the 10-byte Key Serial Number in the <b>KSN</b> argument field.<br><br><b>Input:</b> BDK in hex.<br><b>Arguments:</b> choose whether to derive the IPEK or the transaction key, provide the KSN, choose the variant, and optionally return JSON.<br><br>This operation derives TDES DUKPT keys (ANSI X9.24 Part 1) in software for test and interoperability work. It uses a 16-byte BDK and a 10-byte KSN. For AES DUKPT (ANSI X9.24 Part 3), which uses a 12-byte KSN and AES keys, use the <b>DUKPT Derive AES Key</b> operation.";
        ...
        this.args = [
            ...
            },
            {
                ...
                "type": "string",
                "value": "",
                "comment": "Provide the full 10-byte KSN as 20 hex characters, for example <code>FFFF9876543210E00008</code>. Spaces are allowed. Note: AES DUKPT uses a 12-byte KSN — this operation only accepts 10-byte TDES DUKPT KSNs."
            },
            {
