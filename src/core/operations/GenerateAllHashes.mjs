...
class GenerateAllHashes extends Operation {
    ...
    constructor() {
        ...
        this.checksums = [
            {
                name: "Fletcher-8",
                algo: new Fletcher8Checksum(),
                inputType: "byteArray",
                params: [],
            },
            {
                name: "Fletcher-16",
                algo: new Fletcher16Checksum(),
                inputType: "byteArray",
                params: [],
            },
            {
                name: "Fletcher-32",
                algo: new Fletcher32Checksum(),
                inputType: "byteArray",
                params: [],
            },
            {
                name: "Fletcher-64",
                algo: new Fletcher64Checksum(),
                inputType: "byteArray",
                params: [],
            },
            {
                name: "Adler-32",
                algo: new Adler32Checksum(),
                inputType: "byteArray",
                params: [],
            },
            {
                name: "CRC-8",
                algo: new CRC8Checksum(),
                inputType: "arrayBuffer",
                params: ["CRC-8"],
            },
            {
                name: "CRC-16",
                algo: new CRC16Checksum(),
                inputType: "arrayBuffer",
                params: [],
            },
            {
                name: "CRC-32",
                algo: new CRC32Checksum(),
                inputType: "arrayBuffer",
                params: [],
            },
        ];
    ...
    run(input, args) {
        ...
        this.hashes.forEach((hash) => {
            digest = this.executeAlgo(
                hash.algo,
                hash.inputType,
                hash.params || [],
            );
            output += this.formatDigest(
                digest,
                length,
                includeNames,
                hash.name,
