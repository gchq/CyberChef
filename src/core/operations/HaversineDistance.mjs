...
class HaversineDistance extends Operation {
    ...
    constructor() {
        ...
        this.module = "Default";
        this.description = "Returns the distance between two pairs of GPS latitude and longitude coordinates in metres.<br><br>e.g. <code>51.487263,-0.124323, 38.9517,-77.1467</code>";
