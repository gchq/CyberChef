...
class AnalyseHash extends Operation {
    ...
    run(input, args) {
        ...
        switch (bitLength) {
            case 4:
                possibleHashFunctions = ["Fletcher-4", "Luhn algorithm", "Verhoeff algorithm"];
                break;
            case 8:
                possibleHashFunctions = ["Fletcher-8"];
                break;
            case 16:
                possibleHashFunctions = ["BSD checksum", "CRC-16", "SYSV checksum", "Fletcher-16"];
                break;
            case 32:
            ...
            case 64:
                ...
                break;
            case 128:
                possibleHashFunctions = ["MD5", "MD4", "MD2", "HAVAL-128", "RIPEMD-128", "Snefru", "Tiger-128"];
                break;
            case 160:
                possibleHashFunctions = [
                    "SHA-1",
            ...
            case 192:
                ...
                break;
            case 224:
                possibleHashFunctions = ["SHA-224", "SHA3-224", "ECOH-224", "FSB-224", "HAVAL-224"];
                break;
            case 256:
                possibleHashFunctions = [
                    "SHA-256",
            ...
            case 320:
                ...
                break;
            case 384:
                possibleHashFunctions = ["SHA-384", "SHA3-384", "ECOH-384", "FSB-384"];
                break;
            case 512:
                possibleHashFunctions = [
                    "SHA-512",
