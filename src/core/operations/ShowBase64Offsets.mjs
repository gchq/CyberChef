    ...
    run(input, args) {
        ...
        if (len0 % 4 === 2) {
            ...
            offset0 =
                ...
                Utils.escapeHtml(
                    fromBase64(staticSection, alphabet).slice(0, -2),
                ) +
                "'>" +
                staticSection +
                "</span>" +
            ...
            offset0 =
                "<span data-toggle='tooltip' data-placement='top' title='" +
                Utils.escapeHtml(
                    fromBase64(staticSection, alphabet).slice(0, -1),
                ) +
                "'>" +
                staticSection +
                "</span>" +
        ...
        if (len1 % 4 === 2) {
            ...
            offset1 =
                ...
                "<span data-toggle='tooltip' data-placement='top' title='" +
                Utils.escapeHtml(
                    fromBase64("AA" + staticSection, alphabet).slice(1, -2),
                ) +
                "'>" +
                staticSection +
                "</span>" +
            ...
            offset1 =
                ...
                "<span data-toggle='tooltip' data-placement='top' title='" +
                Utils.escapeHtml(
                    fromBase64("AA" + staticSection, alphabet).slice(1, -1),
                ) +
                "'>" +
                staticSection +
                "</span>" +
            ...
            offset1 =
                ...
                "<span data-toggle='tooltip' data-placement='top' title='" +
                Utils.escapeHtml(
                    fromBase64("AA" + staticSection, alphabet).slice(1),
                ) +
                "'>" +
                staticSection +
                "</span>";
        ...
        if (len2 % 4 === 2) {
            ...
            offset2 =
                ...
                "<span data-toggle='tooltip' data-placement='top' title='" +
                Utils.escapeHtml(
                    fromBase64("AAA" + staticSection, alphabet).slice(2, -2),
                ) +
                "'>" +
                staticSection +
                "</span>" +
            ...
            offset2 =
                ...
                "<span data-toggle='tooltip' data-placement='top' title='" +
                Utils.escapeHtml(
                    fromBase64("AAA" + staticSection, alphabet).slice(2),
                ) +
                "'>" +
                staticSection +
                "</span>";
