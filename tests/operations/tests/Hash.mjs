...
TestRegister.addTests([
    ...
    },
    {
        ...
        input: "Hello, World!",
        expectedOutput:
            "4eaaf0e7a1e400efba71130722e1cb4d59b32afb400e654afec4f8ce",
        recipeConfig: [
            {
                op: "Keccak",
                args: ["224"],
    ...
    },
    {
        ...
        input: "Hello, World!",
        expectedOutput:
            "65736daba648de28ef4c4a316b4684584ecf9f22ddb5c457729e6bf0f40113c4",
        recipeConfig: [
            {
                op: "Snefru",
                args: ["256", "2"],
    ...
    },
    {
        ...
        input: "Hello, World!",
        expectedOutput:
            "71b0ea4b3e33f2e58bcc67c8a8de060b99ec0107355bbfdc18d8f65f0194ffcc",
        recipeConfig: [
            {
                op: "Snefru",
                args: ["256", "4"],
    ...
    },
    {
        ...
        input: "Hello, World!",
        expectedOutput:
            "255cd401414c79588cf689e8d5ff0536a2cfab83fcae36e654f202b09bc4b8a7",
        recipeConfig: [
            {
                op: "Snefru",
                args: ["256", "8"],
    ...
    },
    {
        ...
        input: "Hello, World!",
        expectedOutput:
            "7ed26cbf0bee4ca7d55c1e64714c4aa7d1f163089ef5ceb603cd102c81fbcbc5",
        recipeConfig: [
            {
                op: "SM3",
                args: ["256", "64"],
        ...
        recipeConfig: [
            {
                ...
                args: [
                    {
                        option: "Hex",
                        string: "0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b",
                    },
                    "SHA224",
                ],
            },
        ...
        recipeConfig: [
            ...
            },
            {
                ...
                args: [
                    {
                        option: "Hex",
                        string: "0102030405060708090a0b0c0d0e0f10111213141516171819",
                    },
                    "SHA224",
                ],
            },
        ...
        recipeConfig: [
            {
                ...
                args: [
                    {
                        option: "Hex",
                        string: "",
                    },
                    "SHA224",
                ],
            },
    ...
    },
    {
        ...
        input: "10dc10e32010de10d010dc10d810d910d010e12e",
        expectedOutput:
            "66c166eba2529ecc44a7b7b218a64a8e3892f873c8d231e8e3c1ef3d",
        recipeConfig: [
            {
                op: "From Hex",
                args: ["None"],
    ...
    },
    {
        ...
        input: "10dc10e32010de10d010dc10d810d910d010e12e",
        expectedOutput:
            "186ffd22c3af83995afa4a0316023f81a7f8834fd16bd2ed358c7b1b8182ba41",
        recipeConfig: [
            {
                op: "From Hex",
                args: ["None"],
    ...
    },
    {
        ...
        input: "10dc10e32010de10d010dc10d810d910d010e12e",
        expectedOutput:
            "e2c07562ee8c2d73e3dd309efea257159abd0948ebc14619bab9ffb3",
        recipeConfig: [
            {
                op: "From Hex",
                args: ["None"],
    ...
    },
    {
        ...
        input: "10dc10e32010de10d010dc10d810d910d010e12e",
        expectedOutput:
            "55a55275387586afd1ed64757c9ee7ad1d96ca81a5b7b742c40127856ee78a2d",
        recipeConfig: [
            {
                op: "From Hex",
                args: ["None"],
    ...
    },
    {
        ...
        input: "ნუ პანიკას",
        expectedOutput:
            "563ca57b500157717961a5fa87ce42c6db76a488c98ea9c28d620770",
        recipeConfig: [
            {
                op: "SHA2",
                args: ["224"],
    ...
    },
    {
        ...
        input: "ნუ პანიკას",
        expectedOutput:
            "36abbb4622ffff06aa3e3cea266765601b21457bb3755a0a2cf0a206422863c1",
        recipeConfig: [
            {
                op: "SHA2",
                args: ["256"],
    ...
    },
    {
        ...
        input: "ნუ პანიკას",
        expectedOutput:
            "b3ffc9620949f879cb561fb240452494e2566cb4e4f701a85715e14f",
        recipeConfig: [
            {
                op: "SHA3",
                args: ["224"],
    ...
    },
    {
        ...
        input: "ნუ პანიკას",
        expectedOutput:
            "b5f247d725b46546c832502cd07bccb5d4de0c41a6665d3944ed2cc55cd9d156",
        recipeConfig: [
            {
                op: "SHA3",
                args: ["256"],
        ...
        recipeConfig: [
            {
                op: "Bcrypt compare",
                args: [
                    "$2a$10$qyon0LQCmMxpFFjwWH6Qh.dDdhqntQh./IN0RXCc3XIMILuOYZKgK",
                ],
            },
        ],
    },
