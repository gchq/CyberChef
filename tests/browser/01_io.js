...
module.exports = {
    ...
    "CodeMirror has loaded correctly": (browser) => {
        ...
        browser
            ...
            .waitForElementVisible(
                "#input-text .cm-editor .cm-scroller .cm-content .cm-line",
            )
            // Output
            ...
            .waitForElementVisible(
                "#output-text .cm-editor .cm-scroller .cm-content .cm-line",
            );
        ...
        browser // Input
            ...
            .waitForElementVisible(
                "#input-text .cm-status-bar .stats-length-value",
            )
            .expect.element("#input-text .cm-status-bar .stats-length-value")
            .text.to.equal("0");
        browser
            .waitForElementVisible(
                "#input-text .cm-status-bar .stats-lines-value",
            )
        ...
        browser // Output
            ...
            .waitForElementVisible(
                "#output-text .cm-status-bar .stats-length-value",
            )
            .expect.element("#output-text .cm-status-bar .stats-length-value")
            .text.to.equal("0");
        browser
            .waitForElementVisible(
                "#output-text .cm-status-bar .stats-lines-value",
            )
            .expect.element("#output-text .cm-status-bar .stats-lines-value")
            .text.to.equal("1");
        browser
            .waitForElementVisible(
                "#output-text .cm-status-bar .baking-time-info",
            )
    ...
    "Adding content": (browser) => {
        ...
        browser.expect
            .element("#input-text .cm-status-bar .stats-length-value")
            .text.to.equal("301");
        browser.expect
            .element("#input-text .cm-status-bar .stats-lines-value")
            .text.to.equal("3");
        browser.expect
            .element("#input-text .cm-status-bar .chr-enc-value")
            .text.to.equal("Raw Bytes");
        browser.expect
            .element("#input-text .cm-status-bar .eol-value")
            .text.to.equal("LF");

        browser.expect
            .element("#output-text .cm-status-bar .stats-length-value")
            .text.to.equal("0");
        browser.expect
            .element("#output-text .cm-status-bar .stats-lines-value")
            .text.to.equal("1");
        browser.expect
            .element("#output-text .cm-status-bar .baking-time-info")
            .text.to.contain("ms");
        browser.expect
            .element("#output-text .cm-status-bar .chr-enc-value")
            .text.to.equal("Raw Bytes");
        browser.expect
            .element("#output-text .cm-status-bar .eol-value")
            .text.to.equal("LF");
    ...
    "Special content": (browser) => {
        ...
        for (let i = 0x0; i <= 0x8; i++) {
            browser.expect
                .element(
                    `#input-text .cm-line:nth-of-type(1) .cm-specialChar:nth-of-type(${
                        i + 1
                    })`,
                )
                ...
                .equals(
                    `Control character ${
                        CONTROL_CHAR_NAMES[i] || "0x" + i.toString(16)
                    }`,
                );
            browser.expect
                .element(
        ...
        for (let i = 0x0b; i < SPECIAL_CHARS.length; i++) {
            ...
            const value =
                index >= 32 ? "\u2022" : String.fromCharCode(0x2400 + index);

            browser.expect
                .element(
                    `#input-text .cm-line:nth-of-type(2) .cm-specialChar:nth-of-type(${
                        i - 10
                    })`,
                )
                .to.have.property("title")
        ...
        for (let i = 0x0; i <= 0x8; i++) {
            browser.expect
                .element(
                    `#output-text .cm-line:nth-of-type(1) .cm-specialChar:nth-of-type(${
                        i + 1
                    })`,
                )
                .to.have.property("title")
        ...
        for (let i = 0x0b; i < SPECIAL_CHARS.length; i++) {
            ...
            browser.expect
                .element(
                    `#output-text .cm-content .cm-line:nth-of-type(2) .cm-specialChar:nth-of-type(${
                        i - 10
                    })`,
                )
                .to.have.property("title")
        ...
        */
        ...
        browser
            .doubleClick(
                "#output-text .cm-content .cm-line:nth-of-type(1) .cm-specialChar:nth-of-type(1)",
            )
    ...
    "HTML output": (browser) => {
        ...
        browser.expect.element(
            "#output-text .cm-status-bar .disabled .stats-length-value",
        ).to.be.visible;
        browser.expect.element(
            "#output-text .cm-status-bar .disabled .stats-lines-value",
        ).to.be.visible;
        browser.expect.element(
            "#output-text .cm-status-bar .disabled .chr-enc-value",
        ).to.be.visible;
        browser.expect.element(
            "#output-text .cm-status-bar .disabled .eol-value",
        ).to.be.visible;
    ...
    Highlighting: (browser) => {
        ...
        browser // Input
            ...
            .waitForElementVisible(
                "#input-text .cm-selectionLayer .cm-selectionBackground",
            )
            .waitForElementNotPresent(
                "#input-text .cm-content .cm-line:nth-of-type(1) .cm-selectionMatch",
            )
            .waitForElementNotPresent(
                "#input-text .cm-content .cm-line:nth-of-type(2) .cm-selectionMatch",
            )
            .waitForElementVisible(
                "#input-text .cm-content .cm-line:nth-of-type(3) .cm-selectionMatch",
            )
            .waitForElementNotPresent(
                "#input-text .cm-content .cm-line:nth-of-type(4) .cm-selectionMatch",
            )
            .waitForElementVisible(
                "#input-text .cm-content .cm-line:nth-of-type(5) .cm-selectionMatch",
            )
            .waitForElementNotPresent(
                "#input-text .cm-content .cm-line:nth-of-type(6) .cm-selectionMatch",
            )
            .waitForElementVisible(
                "#input-text .cm-content .cm-line:nth-of-type(7) .cm-selectionMatch",
            );

        browser // Output
            .waitForElementVisible(
                "#output-text .cm-selectionLayer .cm-selectionBackground",
            )
            .waitForElementNotPresent(
                "#output-text .cm-content .cm-line:nth-of-type(1) .cm-selectionMatch",
            )
            .waitForElementNotPresent(
                "#output-text .cm-content .cm-line:nth-of-type(2) .cm-selectionMatch",
            )
            .waitForElementVisible(
                "#output-text .cm-content .cm-line:nth-of-type(3) .cm-selectionMatch",
            )
            .waitForElementNotPresent(
                "#output-text .cm-content .cm-line:nth-of-type(4) .cm-selectionMatch",
            )
            .waitForElementVisible(
                "#output-text .cm-content .cm-line:nth-of-type(5) .cm-selectionMatch",
            )
            .waitForElementNotPresent(
                "#output-text .cm-content .cm-line:nth-of-type(6) .cm-selectionMatch",
            )
            .waitForElementVisible(
                "#output-text .cm-content .cm-line:nth-of-type(7) .cm-selectionMatch",
            );
        ...
        browser // Output
            ...
            .waitForElementNotPresent(
                "#input-text .cm-content .cm-line .cm-selectionMatch",
            )
            .waitForElementNotPresent(
                "#output-text .cm-content .cm-line .cm-selectionMatch",
            )
    ...
    "Character encoding": (browser) => {
        ...
        browser
            .click("#btn-new-tab")
            .waitForElementVisible(
                "#input-tabs li:nth-of-type(2).active-input-tab",
            );
        browser.expect
            .element("#input-text .chr-enc-value")
            .text.that.equals("Raw Bytes");
        browser.expect
            .element("#output-text .chr-enc-value")
            .text.that.equals("Raw Bytes");
        ...
        browser
            ...
            .waitForElementVisible(
                "#input-tabs li:nth-of-type(1).active-input-tab",
            );
        browser.expect
            .element("#input-text .chr-enc-value")
            .text.that.equals("UTF-8");
        browser.expect
            .element("#output-text .chr-enc-value")
            .text.that.equals("UTF-8");
    ...
    "Line endings": (browser) => {
        ...
        browser
            .waitForElementPresent(
                "#input-text .cm-content .cm-line:nth-of-type(3)",
            )
            .waitForElementNotPresent(
                "#input-text .cm-content .cm-line:nth-of-type(4)",
            )
            .waitForElementNotPresent(
                "#input-text .cm-content .cm-specialChar",
            );
        browser.expect
            .element("#input-text .cm-status-bar .stats-length-value")
            .text.to.equal("301");
        ...
        browser
            .waitForElementPresent(
                "#output-text .cm-content .cm-line:nth-of-type(3)",
            )
            .waitForElementNotPresent(
                "#output-text .cm-content .cm-line:nth-of-type(4)",
            )
            .waitForElementNotPresent(
                "#output-text .cm-content .cm-specialChar",
            );
        browser.expect
            .element("#output-text .cm-status-bar .stats-length-value")
            .text.to.equal("301");
        ...
        browser
            .waitForElementPresent(
                "#input-text .cm-content .cm-line:nth-of-type(1)",
            )
            .waitForElementNotPresent(
                "#input-text .cm-content .cm-line:nth-of-type(2)",
            )
            .waitForElementPresent("#input-text .cm-content .cm-specialChar");
        browser.expect
            .element("#input-text .cm-content .cm-specialChar")
            .text.to.equal("␊");
        browser.expect
            .element("#input-text .cm-status-bar .stats-length-value")
            .text.to.equal("301");
        ...
        browser
            .waitForElementPresent(
                "#output-text .cm-content .cm-line:nth-of-type(1)",
            )
            .waitForElementNotPresent(
                "#output-text .cm-content .cm-line:nth-of-type(2)",
            )
            .waitForElementPresent("#output-text .cm-content .cm-specialChar");
        browser.expect
            .element("#output-text .cm-content .cm-specialChar")
            .text.to.equal("␊");
        browser.expect
            .element("#output-text .cm-status-bar .stats-length-value")
            .text.to.equal("301");
        ...
        browser
            ...
            .waitForElementPresent(
                "#input-text .cm-content .cm-line:nth-of-type(1) .cm-specialChar:nth-of-type(3)",
            );
        browser.expect
            .element(
                "#input-text .cm-content .cm-line:nth-of-type(1) .cm-specialChar:nth-of-type(3)",
        ...
        browser
            ...
            .waitForElementPresent(
                "#output-text .cm-content .cm-line:nth-of-type(2) .cm-specialChar",
            );
        browser.expect
            .element(
                "#output-text .cm-content .cm-line:nth-of-type(2) .cm-specialChar",
        ...
        browser.expect
            .element("#input-text .eol-value")
            .text.that.equals("CRLF");
        browser.expect
            .element("#output-text .eol-value")
            .text.that.equals("CR");
    },
    ...
    "File inputs": (browser) => {
        ...
        browser
            ...
            .waitForElementVisible(
                "#input-text .cm-file-details .file-details-toggle-shown",
            )
            .waitForElementVisible(
                "#input-text .cm-file-details .file-details-thumbnail",
            )
            .waitForElementVisible(
                "#input-text .cm-file-details .file-details-name",
            )
            .waitForElementVisible(
                "#input-text .cm-file-details .file-details-size",
            )
            .waitForElementVisible(
                "#input-text .cm-file-details .file-details-type",
            )
            .waitForElementVisible(
                "#input-text .cm-file-details .file-details-loaded",
            );
        browser.expect
        ...
        browser
            ...
            .waitForElementVisible(
                "#input-text .cm-file-details .file-details-toggle-hidden",
            )
    ...
    "Folder inputs": (browser) => {
        ...
        for (let i = 1; i < 3; i++) {
            browser
                ...
                .waitForElementVisible(
                    `#input-tabs li:nth-of-type(${i}).active-input-tab`,
                );
    ...
    "Loading from URL": (browser) => {
        ...
        browser.expect
            .element("#input-text .chr-enc-value")
            .text.that.equals("KOI8-U Ukrainian Cyrillic");
        browser.expect
            .element("#output-text .chr-enc-value")
            .text.that.equals("UTF-16BE");
    ...
    "Replace input with output": (browser) => {
        ...
        utils.loadRecipe(
            ...
            [{ option: "Hex", string: "65" }, "Standard", false],
        );
        ...
        browser.expect
            .element("#input-text .chr-enc-value")
            .text.that.equals("UTF-7");
        browser.expect.element("#input-text .eol-value").text.that.equals("LS");
        browser.expect
            .element(
                "#input-text .cm-line:nth-of-type(1) .cm-specialChar:nth-of-type(1)",
            )
            .text.to.equal("␍");
        browser.expect
            .element(
                "#input-text .cm-line:nth-of-type(1) .cm-specialChar:nth-of-type(49)",
            )
            .text.to.equal("␑");
        browser.waitForElementNotPresent(
            "#input-text .cm-line:nth-of-type(1) .cm-specialChar:nth-of-type(50)",
        );
    },
